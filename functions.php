...
// by mohjak: get translated excerpt issue #242
function get_translated_excerpt() {
	global $post;
	$lang = qtranxf_getLanguage();

	return qtranxf_use_language($lang, get_the_excerpt());
}
...
function insert_fb_in_head() {
	...
	echo '<meta property="og:description" content="'. get_translated_excerpt() .'"/>';
...
function insert_twitter_cards_in_head() {
	...
	$twitter_desc = get_translated_excerpt();
	...
	<meta name="twitter:site" content="@third_pole" />
<?php if ($twitter_name) { ?>
